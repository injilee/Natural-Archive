...
const Travel = props => {
  const arrayLength = data.archivePictures[3].travel.length;
    ...
    <>
      <CarouselWrap>
        ...
        <Carousel ref={carousel}>
          {data.archivePictures[3].travel.map(travel => (
            <CarouselItem key={travel.key}>
              <div>
                <img onContextMenu={handleRightClick} src={travel.imgUrl} alt={travel.alt} />
              </div>
            </CarouselItem>
          ))}
        </Carousel>
